<div class="panel">
    <div class="panel-heading">
        ...
        <div class="pull-right btn-group"><a href="/<?=$data['GKGName'];?>/admin" class="btn btn-xs btn-success"><< к списку</a>
            <a href="/<?=$data['GKGName'];?>/admin/tocsv" class="btn btn-xs btn-primary">Скачать CSV</a><a
                href="/<?=$data['GKGName'];?>/admin/fromcsv" class="btn btn-xs btn-default">Загрузить CSV</a></div>
    </div>
    <div class="panel-body">
        <form action="/<?=$data['GKGName'];?>/admin/fromcsv" method="post" enctype="multipart/form-data">
