<?php
namespace modules\alfa_bank\controllers;
use core\Controller;
use core\Html;
use core\Tools;
use core\Response;
...
class Index extends Controller
{
	...
	{
	    parent::__construct();
		$this->model         = new \modules\alfa_bank\models\Alfa_bank_api();
	...
	*/
    ...
    public function actionForm($id = false, $ajax=false)
    {
        /* ----------------------- Укажите темлейт формы ----------------- */
         if ($ajax!=false) {
            echo $this->render("Index.php", $this->model->factory($id));
        } else {
            html()->content = $this->render("Index.php", $this->model->factory($id));
    ...
    public function postFromCsv()
    {
        ...
        header("Location: /alfa_bank/admin");
    }
