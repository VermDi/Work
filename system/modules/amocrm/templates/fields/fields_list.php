            ...
            <?php foreach ($data as $Row) {
                if ($Row->category == 1) {
                    ...
                    <tr role="row">
                        ...
                        <td>
                            <?php if ($Row->type != 'tracking_data') { ?>
                                <div class="text-center" style="min-width: 110px;">
                                    <div class="btn-group amo_fields_a">
                                        <a href="/amocrm/admin/edit/<?= $Row->id ?>"
                                                class="btn btn-xs btn-success " title="Редактировать"><i
                                                    class="glyphicon glyphicon-edit"></i></a>
                                        <a href="/amocrm/admin/delete/<?= $Row->id ?>"
            ...
            <?php foreach ($data as $Row) {
                if ($Row->category == 2) {
                    ...
                    <tr role="row">
                        ...
                        <td><?= $Row->is_api_only == 1 ? 'Редактирование только из Api' : 'Редактирование из Api и аккаунта AmoCRM ' ?></td>
                        <td>
                            <?php if (!in_array($Row->name, ['Email', 'Телефон', 'Должность'])) { ?>
                                <div class="text-center" style="min-width: 110px;">
                                    <div class="btn-group">
