        ...
        <div style="display: flex; flex-direction: column;">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select name="category" class="form-control">
                        <?php foreach ($data['category'] as $key_type => $val_type) { ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <dev><b>*</b>Имя поля в form <b>(name= "")</b>, а так же ключ в массиве для отправки данных по
                        API<br></dev>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select name="type" class="form-control">
                        <?php foreach ($data['field_type'] as $key_type => $val_type) { ?>
                            <option value="<?= $key_type ?>"><?= $val_type ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <dev><b>*</b>Редактирование поля только из API, или же из API а так же личного аккаунта AmoCRM<br>
                    </dev>
                </div>
            </div>
        </div>
