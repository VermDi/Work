...
define("_DB_NAME_", "u1940719_mind_cms"); // название базы данных
define("_DB_SERVER_", "localhost"); // путь к базе данных (сервер)
define("_DB_USER_", "u1940719_default"); // имя пользователя
define("_DB_PASS_", "tZFlx6hjI9JIR40w"); // пароль для пользователя
...
define("_SECRET_KEY_", "a4bfe6d47a3716c034d9b5f1622cc6afbef1860fe657fd159f694053b65d5279");
define("_NONCE_", "ae9d5a79dec5c0a02dcfa875dbaf02f6e779e789e2aa42ec");
...
define("_ROOT_PATH_", "/var/www/u1940719/data/www/pavlovdmitriy-dev.ru/www");
