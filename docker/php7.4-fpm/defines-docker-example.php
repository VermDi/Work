...
define("_DB_SERVER_", "mysql"); // путь к базе данных (сервер)
define("_DB_USER_", "user"); // имя пользователя
define("_DB_PASS_", "User!Q@W3"); // пароль для пользователя
...
define("_SECRET_KEY_", "cdf0aab7fbebb8ceab7cd97c5f438cab9a05dd962a19de7cdf0d21407713bf74");
define("_NONCE_", "f9e85dbfedfbe25747e97520124dd800dfdf5f9ed8eafeb3");
