...
(function($) {
	...
	Calendar.prototype._update_month_year = function() {
		...
		var self = this;
		var activecell = 0;
		var plusbox = $(document.createElement('div')).attr('id', 'plus-event-tick').addClass('btn btn-success btn-xs').html('<i class="plus-box glyphicon glyphicon-plus"></i>');
        //
		 self.context.find('.cal-month-day')
		 	.on('mouseenter', function() {
	...
	// 	});
        ...
        var modal = $(self.options.modal);
       // console.log(self);
        //var day_date=self.find.data('cal-date');
		plusbox.click(function(event) {

            modal.modal({remote:'/seo/payments/newEvent/'+$(this).parent().find("span[data-cal-view=day]").data('cal-date')});
		...
		modal.on('shown.bs.modal',function () {
            ...
            $(function () {
                ...
                $transaction_date.datepicker({
                    ...
                    current: $transaction_date.val(),

                    starts: 1,
                    position: 'r',

                    onBeforeShow: function () {
                        $transaction_date.DatePickerSetDate($transaction_date.val(), true);
                        $transaction_date.datepicker({
                            changeMonth: true,
                            changeYear: true
                        })
	...
	function showEventsList(event, self) {
