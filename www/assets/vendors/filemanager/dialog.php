...
<input type="hidden" id="current_url"
	   value="<?php echo str_replace(['&filter=' . $filter, '&sort_by=' . $sort_by, '&descending=' . intval($descending)], [''], $base_url . $_SERVER['REQUEST_URI']); ?>"/>
...
<div class="container-fluid">
	...
	if ($ftp) {
		...
		if (!is_dir($current_path . $rfm_subfolder . $subdir)) {
			mkdir($current_path . $rfm_subfolder . $subdir, 0775);
		}
