...
(function ($, window, document, undefined) {
        ...
        Inputmask.prototype = {
            ...
            defaults: {
                ...
                canClearPosition: $.noop, //hook to alter the clear behavior in the stripValidPositions args => maskset, position, lastValidPosition, opts => return true|false/command rent
                preValidation: null, //hook to preValidate the input.  Usefull for validating regardless the definition.	args => buffer, pos, char, isSelection, opts => return true/false/command rent
        ...
        function maskScope(actionObj, maskset, opts) {
            ...
            function isValid(pos, c, strict, fromSetValid, fromAlternate, validateOnly) { //strict true ~ no correction or autofill
                ...
                var maskPos = pos;
                if (pos.begin !== undefined) { //position was a position rent - used to handle a delete by typing over a selection
                ...
                function _isValid(position, c, strict) {
                    ...
                    $.each(getTests(position), function (ndx, tst) {
                            ...
                            getBuffer(true);
                            //return is false or a json rent => { pos: ??, c: ??} or true
                            rslt = test.fn != null ?
            ...
            var EventRuler = {
                on: function (input, eventName, eventHandler) {
                    var ev = function (e) {
                        ...
                        if (this.inputmask === undefined && this.nodeName !== "FORM") { //happens when cloning an rent with jquery.clone
